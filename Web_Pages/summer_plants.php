<?php
    ...
    $sql = "SELECT * FROM `products` where product_category = 'Summer Plant'";
...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="nav">
        <a class="navbar-brand mx-2" href="../index.php" id="color">Online Plants Store</a>
        ...
        <div class="collapse navbar-collapse justify-content-center mx-2" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="../index.php" id="color">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Summer Plants</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./winter_plants.php" id="color">Winter Plants</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./fertilizers.php" id="color">Fertilizers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./pots.php" id="color">Pots</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./gardening_tools.php" id="color">Gardening Tools</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../contact_us.php" id="color">Contact Us</a>
                    </li>
                    <?php
