<?php
    ...
    $sql = "SELECT * FROM `products` where product_category = 'Gardening Tool'";
        ...
        <div class="collapse navbar-collapse justify-content-center mx-2" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./summer_plants.php" id="color">Summer Plants</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Gardening Tools</a>
                    </li>
                    <li class="nav-item">
