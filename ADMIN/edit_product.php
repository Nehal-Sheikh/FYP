            ...
            <div class="col-11 col-lg-6 col-md-10 col-sm-10">
                <div class="card border-0 shadow">
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h4 style="margin-bottom: 30px;">Edit Product</h4>
                        <form action="edit_product_post.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="product_name" id="product_name" class="form-control my-4 py-2" value="<?php echo $row['product_name']; ?>" required>
                            <div class="form-group my-2">
                                <label for="product_category">Product Category</label>
                                <select class="form-control" id="product_category" name="product_category">
                                    <option <?php if ($row['product_category'] === "Summer Plant") echo "selected"; ?>>Summer Plant</option>
                                    <option <?php if ($row['product_category'] === "Winter Plant") echo "selected"; ?>>Winter Plant</option>
                                    <option <?php if ($row['product_category'] === "Fertilizer") echo "selected"; ?>>Fertilizer</option>
                                    <option <?php if ($row['product_category'] === "Gardening Tool") echo "selected"; ?>>Gardening Tool</option>
                                    <option <?php if ($row['product_category'] === "Pot") echo "selected"; ?>>Pot</option>
                                </select>
                            </div>
                            <div class="form-group" style="margin-bottom: 20px;">
                                <label for="product_picture">Upload Product Picture</label><br>
                                <input type="file" class="form-control-file" id="product_picture" name="file">
                            </div>
                            <label for="product_price">Product Price</label>
                            <input type="text" name="product_price" id="product_price" class="form-control my-4 py-2" value="<?php echo $row['product_price']; ?>" required>
