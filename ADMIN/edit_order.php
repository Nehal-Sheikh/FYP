            ...
            <div class="col-11 col-lg-6 col-md-10 col-sm-10">
                <div class="card border-0 shadow">
                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h4 style="margin-bottom: 30px;">Edit Order</h4>
                        <form action="edit_order_post.php" method="post">
                            <input type="hidden" name="order_id" id="order_id" value="<?php echo $row['id'] ?>">
                            <label for="order_name">Ordered Product</label>
                            <input type="text" name="order_name" id="order_name" class="form-control my-4 py-2" value="<?php echo $row['product_name']; ?>" required>
                            ...
                            <input type="text" name="delivery_address" id="delivery_address" class="form-control my-4 py-2" value="<?php echo $row['delivery_address']; ?>" required>
                            <label for="city">City</label>
                            <input type="text" name="city" id="city" class="form-control my-4 py-2" value="<?php echo $row['city']; ?>" required>
                            <label for="phone_number">Phone Number</label>
                            <input type="text" name="phone_number" id="phone_number" class="form-control my-4 py-2" value="<?php echo $row['phone_number']; ?>" required>
                            <div class="form-group my-2">
                                ...
                                <select class="form-control" id="order_status" name="order_status">
                                    ...
                                    <option <?php if ($row['order_status'] === "Fullfilled") echo "selected"; ?>>Fullfilled</option>
                                </select>
                            </div>
