...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="nav">
        <a class="navbar-brand mx-2" href="#" id="color">Online Plants Store</a>
    ...
    <!-- BODY -->
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-bottom: 10rem;">
            <div class="carousel-inner">
                <div class="d-flex justify-content-between carousel-item">
                    <div class="container" style="margin-top: 200px; margin-right: 300px;">
                        <h1>WELCOME</h1>
                        <h2>TO YOUR ONLINE PLANTS STORE</h2>
                        <p>Plants are essential to life on Earth. They play a vital role in the ecosystem by producing oxygen. <br> Plants are used in gardening, medicine, and agriculture. Household plants not only enhance the overall appearance <br> of a space but studies shows that they increase creativity, reduce stress, and eliminate air pollution which helps in helthier and happier you.</p>
                        <a href="/plant/Web_Pages/summer_plants.php" class="btn btn-lg btn-primary">SHOP NOW</a>
                    </div>
        ...
        <div class="container-fluid text-center col-lg-10" style="margin-bottom: 8rem;">
            <h3 class="text-center" style="margin-bottom: 5rem;">PLANTS</h3>                                                                      
            <div class="container-fluid row col-11 col-lg-12 justify-content-center">
                <div>
                    <?php

                        $sql = "SELECT * FROM `products` where product_category = 'Summer Plant' limit 3";
                        ...
                        echo ("
                            <div class='col-11 col-lg-4 col-md-5 col-sm-6'>
                                <div class='card border-0 shadow col-lg-11' style='border-radius: 2.5%; width: 80%; margin-left: 40px;'>
        ...
        <div class="container-fluid text-center col-lg-10" style="margin-bottom: 8rem;">
            <h3 class="text-center" style="margin-bottom: 5rem;">FERTILIZERS</h3>                                                                      
            <div class="container-fluid row col-11 col-lg-12 justify-content-center">
                <div>
                    <?php

                        $sql = "SELECT * FROM `products` where product_category = 'Fertilizer' limit 3";
                        $result = mysqli_query($conn, $sql);
                        ...
                        // Start a new row if the counter is divisible by 3
                        if ($card_count % 3 == 0) {
                            echo '<div class="row justify-content-center" style="margin-bottom: 20px;">';
                        } 
                        echo ("
                            <div class='col-11 col-lg-4 col-md-5 col-sm-6'>
                                <div class='card border-0 shadow col-lg-11' style='border-radius: 2.5%;width: 80%; margin-left: 40px;'>
                                    ...
                                    <div class='card-body text-center'>
                                        ...
                                        <p class='card-text'><b>Rs." . $row["product_price"] . "</b></p>");
                                        if(isset($_SESSION['logged_in_username'])){        
                                            echo ("<a href='./order_form.php?productId=".$row['id']."' class='btn btn-primary'>BUY</a>");
                                        } else {
                                            echo ("<a href='./login.php' class='btn btn-primary'>BUY</a>");
                                        }
                                        echo("
        ...
        <div class="container-fluid text-center col-lg-10" style="margin-bottom: 8rem;">
            <h3 class="text-center" style="margin-bottom: 5rem;">POTS</h3>                                                                      
            <div class="container-fluid row col-11 col-lg-12 justify-content-center">
                <div>
                    <?php

                        $sql = "SELECT * FROM `products` where product_category = 'Pot' limit 3";
                        $result = mysqli_query($conn, $sql);
        ...
        <div class="container-fluid text-center col-lg-10" style="margin-bottom: 8rem;">
            <h3 class="text-center" style="margin-bottom: 5rem;">Gardening Tools</h3>                                                                      
            <div class="container-fluid row col-11 col-lg-12 justify-content-center">
                <div>
                    <?php

                        $sql = "SELECT * FROM `products` where product_category = 'Gardening Tool' limit 3";
                        $result = mysqli_query($conn, $sql);
